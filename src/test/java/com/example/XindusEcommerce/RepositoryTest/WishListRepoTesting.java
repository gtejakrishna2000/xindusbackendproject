...
//        , it returns the mock Authentication object instead of null.
        ...
        UserDetails userDetails = new User(username, "Abc@12345678");
    ...
    public void testFindAllItemsOfUser() {
        ...
        User user1=userRespository.findByUsername("abc");//find the items of  particular user
    ...
    public void testFindById() {
       int itemId=1;
       String expectedusername="abc";//user with name must be exist in db
