...
class UserControllerTest{
    ...
    public void testSuccessfulRegistration_Password() throws Exception {
        ...
        AdduserDto validDto = new AdduserDto(
                "abc", // Unique username
                "Abc@12345678", // Secure password
                "tejakrishnag21@email.com", // Valid email
                "user" // Valid role
        );
    ...
    public void testSuccessfulRegistration_PasswordUppercase() throws Exception {
        ...
        AdduserDto validDto2 = new AdduserDto(
                "abc", // Unique username
                "Abc@12345678", // Secure password
                "tejakrishnag21@gmail.com", // Valid email
                "user" // Valid role
        );
    ...
    public void AdduserToDatabaseThroughUserController()
    {
        ...
        headers.set("Authorization", "Basic " + encodeCredentials("abc", "Abc@12345678"));
        AdduserDto adduserDto=new AdduserDto("abc", "Abc@12345678", "tejakrishnag21@gmail.com", "user");
