...
//        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
    ...
    public void  Delete_By_ItemId()
    {
        ...
        headers.set("Content-Type", "application/json");
        headers.set("Authorization", "Basic " + encodeCredentials("abc", "Abc@12345678"));
        DeleteByIdDto deleteByIdDto=new DeleteByIdDto(1);
        HttpEntity<DeleteByIdDto> requestEntity = new HttpEntity<>(deleteByIdDto, headers);
